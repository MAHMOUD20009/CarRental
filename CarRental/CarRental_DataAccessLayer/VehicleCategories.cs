...
namespace CarRental_DataAccessLayer
{
    public static class clsVehicleCategoryDataAccess
    {
        ...
        {
            string query = @"SELECT * FROM VehiclesCategories 
        ...
        {
            string query = @"Update VehiclesCategories 
                        SET 
        ...
        {
            string query = @"Delete VehiclesCategories 
                     WHERE CategoryID = @CategoryID";
        ...
        {
            string query = @"IF EXISTS(SELECT 1 FROM VehiclesCategories 
