...
namespace CarRental.Returns
{
        public partial class frmReturnDetails : Form
    {
        ...
        private void frmReturnDetails_Load(object sender, EventArgs e)
        {
            ctrlReturnCard1.LoadReturnInfo(_ReturnID);
        }

        private void ctrlReturnCard1_MouseDown(object sender, MouseEventArgs e)
        {
